...
<!--codeinclude-->
[countdown.yaml](assets/jobs/countdown.yaml)
<!--/codeinclude-->

[Download `countdown.yaml` here](assets/jobs/countdown.yaml).
...
<!--codeinclude-->
[job-2.yaml](assets/jobs/job-2.yaml)
<!--/codeinclude-->

[Download `job-2.yaml` here](assets/jobs/job-2.yaml).
...
<!--codeinclude-->
[job-3.yaml](assets/jobs/job-3.yaml)
<!--/codeinclude-->

[Download `job-3.yaml` here](assets/jobs/job-3.yaml).
...
<!--codeinclude-->
[job-4.yaml](assets/jobs/job-4.yaml)
<!--/codeinclude-->

[Download `job-4.yaml` here](assets/jobs/job-4.yaml).
